...
class StockMoveTypeDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'inventory.stock_move_types.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\StockMoveType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(StockMoveType $model)
    {
    ...
    {
        return 'stock_move_types_datatable_' . time();
    }
}
